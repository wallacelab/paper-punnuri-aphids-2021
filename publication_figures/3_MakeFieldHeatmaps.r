...
count1.19=make_plot(field2019, "AV.AC_Aug14_2019", "AC1 (14 Aug 2019)", "# Aphids", purp_low, purp_high, count.limits)
count2.19=make_plot(field2019, "AV.AC_Aug_28_2019", "AC2 (28 Aug 2019)", "# Aphids", purp_low, purp_high, count.limits)
d1.19=make_plot(field2019, "2019D1", "D1 (14 Aug 2019)", "Score", red_low, red_high, damage.limits)
...
count1.20=make_plot(field2020, "AV.AC_Aug11-2020", "AC1 (11 Aug 2020)", "# Aphids", purp_low, purp_high, count.limits)
count2.20=make_plot(field2020, "AV.AC_Aug18-2020", "AC2 (18 Aug 2020)", "# Aphids", purp_low, purp_high, count.limits)
d1.20=make_plot(field2020, "2020D1", "D1 (11 Aug 2020)", "Score", red_low, red_high, damage.limits)
